		...
		<div class="nav" role="navigation">
			<ul>
				<li><a class="home" href="${createLink(uri: '/domain')}"><g:message code="default.home.label"/></a></li>
				 <li><a class="Créer un événement virtuel" href="${createLink(uri: '/virtualEvent/create/')}"><g:message code="Créer un événement virtuel"/></a></li>
                <li><a class="Créer un événement physique" href="${createLink(uri: '/physicalEvent/create/')}"><g:message code="Créer un événement physique"/></a></li>
