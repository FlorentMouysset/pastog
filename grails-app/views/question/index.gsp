...
<html>
	...
	<body>
		...
		<div id="Questions" class="content scaffold-list" role="main">
			<h1><g:message code="Questions:" args="[entityName]" /></h1>
			...
			<thead>
				...
				<g:each in="${questionInstanceList}" status="i" var="questionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${questionInstance.id}">${fieldValue(bean: questionInstance, field: "enunciated")}</g:link></td>
